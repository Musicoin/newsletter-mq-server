...
async function handleMessage(channel, message) {
  ...
  try {
    ...
    const emails = addresses.map(address => {
      ...
      const unsubscribe_html = `<div data-role="module-unsubscribe" class="module unsubscribe-css__unsubscribe___2CDlR" role="module" data-type="unsubscribe" style="color:#444444;font-size:12px;line-height:20px;padding:0px 16px 0px 16px;text-align:center"><p style="font-family:[Sender_Name];font-size:12px;line-height:20px"><a class="Unsubscribe--unsubscribeLink" href="${unsubscribeLink}">Unsubscribe</a> -<a class="Unsubscribe--unsubscribePreferences" href="${unsubscribeLink}">Unsubscribe Preferences</a></p></div>`;
      const real_html = `${html}${INSERT_HTML_1}${unsubscribe_html}${INSERT_HTML_2}`;
      return {
        subject,
        html: real_html,
